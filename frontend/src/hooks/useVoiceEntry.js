 ...
 * speech onto those. Mirrors src/hooks/useVoiceEntry.js in the mobile app.
 *
...
export default function useVoiceEntry(fields) {
  ...
  /** Manual mic click — start/stop capture on the CURRENT field without advancing. */
  ...
  const next = useCallback(() => {
    ...
    // if 'transcribing', a result is already in flight — ignore extra clicks
  }, [state, doAdvance])
